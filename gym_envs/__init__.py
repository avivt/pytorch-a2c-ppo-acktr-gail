...
register(
    id='h_bandit-fixed-v0',
    entry_point='gym.envs.toy_text:HBanditEnv',
    kwargs={'r_dist_name': 'fixed',
            'steps': 20
            },
...
register(
    id='h_bandit-random-v0',
    entry_point='gym.envs.toy_text:HBanditEnv',
    kwargs={'r_dist_name': 'random',
            'steps': 20
            },
    max_episode_steps=20,
    reward_threshold=0.7, # optimum = .8196
...
register(
    id='h_bandit-randchoose-v0',
    entry_point='gym.envs.toy_text:HBanditEnv',
    kwargs={'r_dist_name': 'train',
            'steps': 20
            },
    max_episode_steps=20,
    reward_threshold=0.7, # optimum = .8196
...
register(
    id='h_bandit-randchoose-v2',
    entry_point='gym.envs.toy_text:HBanditEnv',
    kwargs={'r_dist_name': 'train_5',
            'steps': 20
            },
    max_episode_steps=20,
    reward_threshold=0.7, # optimum = .8196
...
register(
    id='h_bandit-randchoose-v3',
    entry_point='gym.envs.toy_text:HBanditEnv',
    kwargs={'r_dist_name': 'train_10',
            'steps': 20
            },
    max_episode_steps=20,
    reward_threshold=0.7, # optimum = .8196
...
register(
    id='h_bandit-randchoose-v6',
    entry_point='gym.envs.toy_text:HBanditEnv',
    kwargs={'r_dist_name': 'train_5_b',
            'steps': 20
            },
    max_episode_steps=20,
    reward_threshold=0.7, # optimum = .8196
...
register(
    id='h_bandit-obs-randchoose-v10',
    entry_point='gym.envs.toy_text:HBanditEnv',
    kwargs={'r_dist_name': 'train_50',
            'steps': 20,
            'arms': 'rand_obs'
            },
    max_episode_steps=20,
...
register(
    id='h_bandit-obs-randchoose-v11',
    entry_point='gym.envs.toy_text:HBanditEnv',
    kwargs={'r_dist_name': 'train_15',
            'steps': 20,
            'arms': 'rand_obs'
...
register(
    id='h_bandit-obs-randchoose-v12',
    entry_point='gym.envs.toy_text:HBanditEnv',
    kwargs={'r_dist_name': 'train_10_b',
            'steps': 20,
            'arms': 'rand_obs'
