...
echo "check testgrad on 5 arms FF training, and noise 0.05, without free exploration, with the randomly generated domains, to compare with the baseline."
echo "noise 0.03 seemed to work pretty well, so trying a bit more noise."